...
const projects = [
  ...
  },
  {
    ...
    description:
      "Повышение квалификации представителей органов государственной власти и местного самоуправления, подведомственных организаций.",
  ...
  },
  {
    ...
    description:
      "Получение востребованных специальностей с выдачей официального документа установленного образца о повышении квалификации или профессиональной переподготовки.",
