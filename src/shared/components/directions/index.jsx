...
const projects = [
  {
    ...
    description: `Реализация основных образовательных программ высшего образования с использованием электронной информационно-образовательной среды Университета. Цифровая образовательная платформа ВО обеспечивает управление пользователями, хранение и систематизацию учебно-методических ресурсов, организацию учебного процесса с применением дистанционных технологий, взаимодействие участников и мониторинг учебного процесса.`,
